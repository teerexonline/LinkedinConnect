          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: '32px', flex: 1 }}>
            ...
            {user && (
              <>
                ...
                <Link
                  href="/discover"
                  style={{ fontFamily: 'var(--font-jakarta)', fontSize: '14px', fontWeight: 500, color: '#4a7fff', textDecoration: 'none', transition: 'color 0.2s' }}
              ...
              <>
                {points !== null && (
                  <div style={{
                    ...
                    <span style={{ fontFamily: 'var(--font-jakarta)', fontSize: '13px', fontWeight: 700, color: '#f5b731' }}>
                      {points}
                    </span>
                  </div>
                )}
